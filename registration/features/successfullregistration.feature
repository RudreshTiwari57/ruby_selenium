Feature: registration page
	Scenario:  to verify user is able to create account   with validate credentials
   ...
   | ruddrseshe   | tiswdarie   | rudrh@gmail.com | 344333324334 | asdsrd | jrsido     | shdhsfhradsbfjhsd | ddsjnffjnsd | hfsdrfs | Maharashtra | 432782468 | India   | rudwar     | rudswar    | rudswar           |
