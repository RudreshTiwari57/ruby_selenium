Feature: registration page
	Scenario:  to verify user gets password mismatch error on entering diffrent pasword and confirm pasword
   ...
   | ruddreshe   | tiwdarie   | ruedrh@gmail.com | 34433334324334 | asdrd | jrido     | shdhsddksafhradsbfjhsd | ddsjnfksdjnfkjsdndnrfjnsd | hfsdrfs | Maharashtra | 432782468 | India   | rudwar     | rudar    | rudwar           |
